...
model, feature_columns = joblib.load('best_model_augmented.pkl')
...
if __name__ == '__main__':
    ...
    required_files = ['best_model_augmented.pkl', 'label_encoders.pkl', 'median_values.pkl', 'unique_values.pkl']
